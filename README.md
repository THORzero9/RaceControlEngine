...
* **Asynchronous Execution Loop**: Invokes `gemini-3.5-flash` with dynamic tool capabilities over an MCP studio channel.
...
* **Diagnostics Health Matrix**: 5-second polling of MongoDB Atlas connections, active Gemini model configuration, and local MCP studio process states.
